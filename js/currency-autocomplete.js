$(function(){
  var currencies = [
    { value: '1 A LAMP FOR OUR STEPS ', data: 'A LAMP FOR OUR STEPS has been given<br>a light has been set on a hill<br>Gods Word in its truth may be trusted,<br>by all who surrender their will.<br><br>To order the chaos of darkness, give hope in the midst of despair,<br>to make of our lives new creations and lighten the burdens we bear.<br><br>Lord, grant to us eyes ever watchful, and ears ever open to hear<br>the Word that in love you are speaking, the Word that dispels all our fear.<br><br>Your death-resurrection has claimed us,<br><br>But pardon our flesh that is weak;<br>You know that our spirits are willing,<br>give strength with the Word that you speak.' },
    { value: '2 A NEW COMMANDMENT', data: 'A NEW COMMANDMENT I give unto you that you love one another as I have loved you [2] By this shall all know that you are my disciples If you have love one for another. True love is patient, not arrogant or boastful; Love bears all things, love is eternal. I am the true Vine, my Father is the Gardner, Abide in me: you will be fruitful. You are my friends now, no longer are you servants I chose you all. You did not choose me.' },
    { value: 'Algerian dinar', src:'index.html' },
  ...
  $('#autocomplete').autocomplete({
    ...
    onSelect: function (suggestion) {
      var thehtml = '<strong>Currency Name:</strong> ' + suggestion.value + ' <br> <strong>Symbol:</strong> ' + suggestion.src;
